...
const uint16_t PortPadConfigData[] = {
	...
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	45 : PORT_PIN_MODE_PWM */
	...
	( PORT_FUNC2 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	53 : PORT_PIN_MODE_PWM */
